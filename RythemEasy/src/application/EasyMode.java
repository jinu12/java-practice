...
public class EasyMode implements Initializable{
	...
	private GraphicsContext gameoverss;
	 int num = 1000;
	int starttime=0;
	...
	Image effect1 = new Image("Images/easy.PNG");
	Image gameovers = new Image("Images/GameoverText.png");
	boolean game;

	 @FXML
	private ImageView effectts;
    @FXML
	...
	public void initialize(java.net.URL arg0, ResourceBundle arg1) {
		...
		gameoverss = gameover.getGraphicsContext2D();
		
		draw();
		effectts.setImage(effect1);
		effectts.setOpacity(0);
	}
	  ...
	  @FXML//image9.getHeight().equals(WhiteBtn1.getLayoutY()
	    void WhitePlay(KeyEvent event) {	  
		  	if(event.getCode() == KeyCode.A) {
		  		...
		  		else if(starttime<=80 && starttime <120) {
		  			Hps.clearRect(55, 0, 50, 720);
		    		Hps.drawImage(process3, 55, 0,50,720);
		  		}
		  		else if(starttime<=160 && starttime <200) {
		  			Hps.clearRect(55, 0, 50, 720);
		    		Hps.drawImage(process4, 55, 0,50,720);
		  		}
		  		else if(starttime<=200 && starttime <240) {
		  			Hps.clearRect(55, 0, 50, 720);
		    		Hps.drawImage(process5, 55, 0,50,720);
		  		}
		  		else if(starttime<=240 && starttime <280) {
		  			Hps.clearRect(55, 0, 50, 720);
		    		Hps.drawImage(process6, 55, 0,50,720);
		  		}
		  		else if(starttime<=280 && starttime <320) {
		  			Hps.clearRect(55, 0, 50, 720);
		    		Hps.drawImage(process7, 55, 0,50,720);
		  		}
		  		else if(starttime<=320 && starttime <360) {
		  			Hps.clearRect(55, 0, 50, 720);
		    		Hps.drawImage(process8, 55, 0,50,720);
		  		}
		  		else if(starttime<=360 && starttime <400) {
		  			Hps.clearRect(55, 0, 50, 720);
		    		Hps.drawImage(process9, 55, 0,50,720);
		  		}
		  		else if(starttime<=400 && starttime <440) {
		  			Hps.clearRect(55, 0, 50, 720);
		    		Hps.drawImage(process10, 55, 0,50,720);
		  		}
		  		if(hp == 4) {
		    	...
		    	if(hp <= 0) {
		            ...
		            TranslateTransition a2 = new TranslateTransition();
		        	a2.setNode(gameover);
		        	a2.setDuration(Duration.seconds(2));		
		        	a2.setToY(400);
		        	a2.setCycleCount(1);
		        	a2.play();
		  		...
		  		if(starttime>=30 && starttime <40) {
		  			effectts.setOpacity(100);
		  			ce.drawImage(good, 0, 0,180,180);
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g2.clearRect(nodeX1[11],nodeY1[11],width,height);
		  			}
		  			ce.drawImage(yellow,0, 0,160,200);
		  		}
		  		
		  		if(starttime>=40 && starttime <50) {
		  			hp--;
		  			ce.drawImage(bad,0, 0,160,200);
		  		}
		  		if(starttime>=50 && starttime <60) {
		  			...
		  			ce.drawImage(perfect, 0, 0,180,180);
		  		}
		  		if(starttime>=60 && starttime <70) {
		  			hp--;
		  			ce.drawImage(bad,0, 0,180,180);
			  		}
		  		...
		  		if(starttime>=150 && starttime <160) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g3.clearRect(nodeX2[0],nodeY2[0],width,height);
		  			}
		  			ce.drawImage(yellow,0, 0,160,160);
		  		...
		  		if(starttime>=210 && starttime <220) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g4.clearRect(nodeX3[0],nodeY3[0],width,height);
		  			}
		  			ce.drawImage(yellow,0, 0,160,160);
		  			ce.drawImage(perfect, 0, 0);
		  		}
		  		...
		  		if(starttime>=230 && starttime <240) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g4.clearRect(nodeX3[3],nodeY3[3],width,height);
		  			}
		  			ce.drawImage(yellow,0, 0,160,160);
		  			ce.drawImage(perfect, 0, 0);
		  		}
		    	...
		    	if(hp <= 0) {
		  		...
		  		if(starttime>=40 && starttime <50) {
		  			...
		  			ce.drawImage(good, 160, 0);
		  			ce.drawImage(sky, 160, 30,160,250);
		  		}
		  		if(starttime>=50 && starttime <60) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  		...
		  		if(starttime>=70 && starttime <80) {
		  			...
		  			ce.drawImage(good, 130, 0);
		  			ce.drawImage(sky, 130, 30,160,250);
		  		}
		  		if(starttime>=80 && starttime <90) {
		  			ce.drawImage(bad, 160, 0);
		  			hp--;
		  		...
		  		if(starttime>=130 && starttime <140) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g3.clearRect(nodeX2[4],nodeY2[4],width,height);
		  			}
		  			ce.drawImage(good, 160, 0);
		  			ce.drawImage(sky, 160, 30,160,250);
		  		}
		  		if(starttime>=140 && starttime <150) { //두번째 첫번째 노드
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g3.clearRect(nodeX2[3],nodeY2[3],width,height);
		  			}
		  			ce.drawImage(good, 160, 0);
		  			ce.drawImage(sky, 160, 30,160,250);
		  		}
		    	...
		    	if(starttime>=30 && starttime <40) {
		  			...
		  			ce.drawImage(yellow,360, 0,180,180);
		  			ce.drawImage(perfect, 0, 0);
		  		}
		  		...
		  		if(starttime>=40 && starttime <50) {
		  			...
		  			System.out.println(hp);
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g2.clearRect(nodeX1[9],nodeY1[9],width,height);
		  			}
		  			ce.drawImage(yellow,360, 0,180,180);
		  			ce.drawImage(perfect, 0, 0);
		  		}
		  		...
		  		if(starttime>=60 && starttime <70) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g2.clearRect(nodeX1[6],nodeY1[6],width,height);
		  			}
		  			ce.drawImage(yellow,360, 360,180,180);
		  			ce.drawImage(perfect, 360, 0);
			  		}
		  		if(starttime>=70 && starttime <80) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g2.clearRect(nodeX1[5],nodeY1[5],width,height);
		  		...
		  		if(starttime>=80 && starttime <90) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g2.clearRect(nodeX1[3],nodeY1[3],width,height);
		  			}
		  			ce.drawImage(yellow,360, 0,180,180);
		  			ce.drawImage(perfect, 360, 0);
		  		}
		  		...
		  		if(starttime>=150 && starttime <160) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g3.clearRect(nodeX2[1],nodeY2[1],width,height);
		  			}
		  			ce.drawImage(good, 360, 0);
		  			ce.drawImage(yellow, 360, 180);
		  		}
		  		if(starttime>=160 && starttime <170) {
		  		...
		  		if(starttime>=330 && starttime <340) { 
		  			g3.clearRect(0,1200,160,80);
		  			ce.drawImage(good, 0, 0);
		  		}
		  		if(starttime>=340 && starttime <350) {
				...
				if(starttime>=20 && starttime <30) {
		  		...
		  		if(starttime>=120 && starttime <130) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g3.clearRect(nodeX2[5],nodeY2[5],width,height);
		  			}
		  			ce.drawImage(good, 0, 0);
		  		}
		  		if(starttime>=130 && starttime <140) {
		  		...
		  		if(starttime>=140 && starttime <150) {
		  			for (int i = 0; i < nodeX1.length; i++) {
		  				g3.clearRect(nodeX2[2],nodeY2[2],width,height);
		  			}
		  			ce.drawImage(good, 360, 0);
		  			ce.drawImage(yellow, 360, 180);
	...
	// 0   165 330 496
    private void draw() {
    	gameoverss.drawImage(gameovers, 100, 0,300,200);
